...
module.exports = {
	...
	buildPage: async function (document, key, log = true) {
		...
		await module.exports.buildForValidation(document, key);
		await module.exports.buildPostValidation(document, key);
	},
	...
	buildForValidation: async function (document, key = "", data = {}) {
		await includes.processDocument(key, document, data, false);
	},
	buildPostValidation: async function (document, key = "", data = {}) {
		await includes.processDocument(key, document, data, true);
	},
}